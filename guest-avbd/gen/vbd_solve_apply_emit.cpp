...
#line 1 "C:/Users/ernest.lee/AppData/Local/Temp/emitted_shaders/vbd_solve_apply.slang"
...
#line 17
    ...
    uint32_t v_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->vertPerm_0.Load((_S2->groupID * Vector<uint32_t, 3> (64U, 1U, 1U) + _S2->groupThreadID).x + (slang_bit_cast<GlobalParams_0*>(globalParams_0))->params_0->colorOffset_0);
    uint32_t hb_0 = 6U * v_0;
    Vector<float, 3>  g_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->gScratch_0.Load(v_0);
    float Hxx_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->hScratch_0.Load(hb_0);
    float Hxy_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->hScratch_0.Load(hb_0 + 1U);
    float Hxz_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->hScratch_0.Load(hb_0 + 2U);
    float Hyy_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->hScratch_0.Load(hb_0 + 3U);
    float Hyz_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->hScratch_0.Load(hb_0 + 4U);
    float Hzz_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->hScratch_0.Load(hb_0 + 5U);
    ...
    Vector<float, 3>  * _S4 = (&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->positions_0)[v_0]);
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->positions_0)[v_0]) = Vector<float, 3> ((*_S4).x + _S3 * (a00_0 * gx_0 + a01_0 * gy_0 + a02_0 * gz_0), (*_S4).y + _S3 * (a01_0 * gx_0 + (Hxx_0 * Hzz_0 - Hxz_0 * Hxz_0) * gy_0 + a12_0 * gz_0), (*_S4).z + _S3 * (a02_0 * gx_0 + a12_0 * gy_0 + (Hxx_0 * Hyy_0 - Hxy_0 * Hxy_0) * gz_0));
    return;
}
