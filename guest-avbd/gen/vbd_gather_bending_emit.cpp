...
#line 1 "C:/Users/ernest.lee/AppData/Local/Temp/emitted_shaders/vbd_gather_bending.slang"
...
#line 25
    ...
    uint32_t sStart_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_1))->vertBendOffset_0.Load(v_0);
    uint32_t _S3 = (slang_bit_cast<GlobalParams_0*>(globalParams_1))->vertBendOffset_0.Load(v_0 + 1U);
