...
#line 1 "C:/Users/ernest.lee/AppData/Local/Temp/emitted_shaders/vbd_gather_spring.slang"
...
#line 25
    ...
    uint32_t v_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_1))->vertPerm_0.Load((_S2->groupID * Vector<uint32_t, 3> (64U, 1U, 1U) + _S2->groupThreadID).x + (slang_bit_cast<GlobalParams_0*>(globalParams_1))->params_0->colorOffset_0);
    uint32_t sStart_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_1))->vertSpringOffset_0.Load(v_0);
    uint32_t _S3 = (slang_bit_cast<GlobalParams_0*>(globalParams_1))->vertSpringOffset_0.Load(v_0 + 1U);
    uint32_t hb_0 = 6U * v_0;
    Vector<float, 3>  * _S4 = (&((slang_bit_cast<GlobalParams_0*>(globalParams_1))->gScratch_0)[v_0]);

    float _S5 = (*_S4).y;
    float _S6 = (*_S4).z;
    float * _S7 = (&((slang_bit_cast<GlobalParams_0*>(globalParams_1))->hScratch_0)[hb_0]);
    uint32_t _S8 = hb_0 + 1U;

#line 36
    float * _S9 = (&((slang_bit_cast<GlobalParams_0*>(globalParams_1))->hScratch_0)[_S8]);
    uint32_t _S10 = hb_0 + 2U;

#line 37
    float * _S11 = (&((slang_bit_cast<GlobalParams_0*>(globalParams_1))->hScratch_0)[_S10]);
    uint32_t _S12 = hb_0 + 3U;

#line 38
    float * _S13 = (&((slang_bit_cast<GlobalParams_0*>(globalParams_1))->hScratch_0)[_S12]);
    uint32_t _S14 = hb_0 + 4U;

#line 39
    float * _S15 = (&((slang_bit_cast<GlobalParams_0*>(globalParams_1))->hScratch_0)[_S14]);
    uint32_t _S16 = hb_0 + 5U;

#line 40
    float * _S17 = (&((slang_bit_cast<GlobalParams_0*>(globalParams_1))->hScratch_0)[_S16]);
...
#line 57
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_1))->gScratch_0)[v_0]) = Vector<float, 3> (gx_0, gy_0, gz_0);
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_1))->hScratch_0)[hb_0]) = Hxx_0;
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_1))->hScratch_0)[_S8]) = Hxy_0;
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_1))->hScratch_0)[_S10]) = Hxz_0;
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_1))->hScratch_0)[_S12]) = Hyy_0;
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_1))->hScratch_0)[_S14]) = Hyz_0;
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_1))->hScratch_0)[_S16]) = Hzz_0;
    return;
}
