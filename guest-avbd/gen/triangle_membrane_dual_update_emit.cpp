...
#line 73 "C:/Users/ernest.lee/AppData/Local/Temp/emitted_shaders/triangle_membrane_dual_update.slang"
...
#line 15
    ...
    Vector<float, 3>  p1_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->positions_0.Load((slang_bit_cast<GlobalParams_0*>(globalParams_0))->idx_0.Load(base_0 + 1U));
    Vector<float, 3>  p2_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_0))->positions_0.Load((slang_bit_cast<GlobalParams_0*>(globalParams_0))->idx_0.Load(base_0 + 2U));
...
#line 69
    ...
    Vector<float, 3>  * _S6 = (&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->lambda0_0)[c_0]);
    Vector<float, 3>  l1_0 = *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->lambda1_0)[c_0]);
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->lambda0_0)[c_0]) = Vector<float, 3> ((*_S6).x + g_0 * (f0x_0 - (e1x_0 * r00_0 + e2x_0 * r10_0)), (*_S6).y + g_0 * (f0y_0 - (e1y_0 * r00_0 + e2y_0 * r10_0)), (*_S6).z + g_0 * (f0z_0 - (e1z_0 * r00_0 + e2z_0 * r10_0)));
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_0))->lambda1_0)[c_0]) = Vector<float, 3> (l1_0.x + g_0 * e1rx_0, l1_0.y + g_0 * e1ry_0, l1_0.z + g_0 * e1rz_0);
    return;
}
