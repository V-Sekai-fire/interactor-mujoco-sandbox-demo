...
#line 1 "C:/Users/ernest.lee/AppData/Local/Temp/emitted_shaders/vbd_gather_attachment.slang"
...
#line 23
    ...
    uint32_t sStart_0 = (slang_bit_cast<GlobalParams_0*>(globalParams_1))->vertAttachOffset_0.Load(v_0);
    uint32_t _S3 = (slang_bit_cast<GlobalParams_0*>(globalParams_1))->vertAttachOffset_0.Load(v_0 + 1U);
...
#line 47
    ...
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_1))->hScratch_0)[_S8]) = Hyy_0;
    *(&((slang_bit_cast<GlobalParams_0*>(globalParams_1))->hScratch_0)[_S10]) = Hzz_0;
    return;
}
